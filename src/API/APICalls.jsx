...
export const getCategoryFnApi = (firstTime) =>async(dispatch)=>{
    try {
        ...
        let response = new Promise((resolve, reject) =>{
            axios.get(`${ REACT_APP_BACKENDAPI}category/find`).then((res)=>{
                const dataSolve = () =>{
...
export const addCategoryFnApi = (payload) =>async(dispatch)=>{
    try {
        ...
        let response = new Promise((resolve, reject) =>{
            axios.post(`${ REACT_APP_BACKENDAPI}category`,payload).then((res)=>{
                const dataSolve = () =>{
                    let firstTime = false
...
export const getProductsFnApi = (firstTime) =>async(dispatch)=>{
    try {
        ...
        let response = new Promise((resolve, reject) =>{
            axios.get(`${ REACT_APP_BACKENDAPI}product/find`).then((res)=>{
                const dataSolve = () =>{
...
export const addProductsFnApi = (payload) =>async(dispatch)=>{
    try {
        ...
        let response = new Promise((resolve, reject) =>{
            axios.post(`${ REACT_APP_BACKENDAPI}product`,payload).then((res)=>{
                const dataSolve = () =>{
                    let firstTime = false
